...
.PHONY: clang-libvector clang-release-vec
.PHONY: msvc-libvector msvc-release-vec
.PHONY: multi-compiler help
.PHONY: test-com test-vec test-all
.PHONY: test-com-verbose test-vec-verbose test-all-verbose
.PHONY: clang-test-com clang-test-vec clang-test-all
.PHONY: clang-test-com-verbose clang-test-vec-verbose clang-test-all-verbose
.PHONY: msvc-test-com msvc-test-vec msvc-test-all
.PHONY: msvc-test-com-verbose msvc-test-vec-verbose msvc-test-all-verbose
.PHONY: coverage
